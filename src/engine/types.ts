...
export type Action =
  ...
  | { type: "claim_timeout" }
  /**
   * סיום מוסכם, כאן ועכשיו.
   *
   * משחק משפחתי נגמר כשנמאס, לא כשכולם פשטו רגל. בלי זה הדרך היחידה
   * לסיים היא לנטוש — ואז אין מנצח, ואף אחד לא יודע מי הוביל.
   * הדירוג לפי שווי נקי, בדיוק כמו בסיום מתוזמן.
   */
  | { type: "finish_now" }
  /**
